...
def get_history(
    ...
    return operation_response(queries.get_history(q=q, action=action, limit=limit, offset=offset, db=db, user_id=user_id))
...
def frequent_categories(
    ...
    return operation_response(queries.frequent_categories(tx_type=tx_type, limit=limit, db=db, user_id=user_id))
...
def transfer_suggestions(
    ...
    return operation_response(transfers.transfer_suggestions(db=db, user_id=user_id))
...
def confirm_transfer_match(
    ...
    return operation_response(transfers.confirm_transfer_match(transaction_id=transaction_id, data=data, db=db, user_id=user_id))
...
def get_transactions(
    ...
    return operation_response(queries.get_transactions(account_id=account_id, currency=currency, type=type, category_id=category_id, tag_id=tag_id, date_from=date_from, date_to=date_to, q=q, is_planned=is_planned, limit=limit, offset=offset, db=db, user_id=user_id))
...
def create_transaction(
    ...
    return operation_response(commands.create_transaction(data=data, idempotency_key=idempotency_key, db=db, user_id=user_id))
...
def bulk_update_category(
    ...
    return operation_response(commands.bulk_update_category(data=data, db=db, user_id=user_id))
...
def update_transaction(
    ...
    return operation_response(commands.update_transaction(transaction_id=transaction_id, data=data, db=db, user_id=user_id))
...
def delete_transaction(
    ...
    return operation_response(commands.delete_transaction(transaction_id=transaction_id, db=db, user_id=user_id))
