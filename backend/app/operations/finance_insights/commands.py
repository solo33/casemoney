"""Finance_insights: commands. Callers supply resolved user and database session."""
from datetime import datetime, timedelta, timezone
from sqlalchemy.orm import Session
from app.models.category import Category
from app.services import accounts as accounts_svc
from app.services.plans import ensure_family_plan
from app.operations.finance_insights.common import _totals
from app.schemas.finance_insights_views import InsightItem, InsightRequest, InsightResponse


def finance_summary(data: InsightRequest, db: Session=None, user_id: int=None):
