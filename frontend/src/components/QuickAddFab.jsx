...
export default function QuickAddFab() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.type === "transfer") {
      ...
      if (form.fee_enabled && Number(form.fee_amount) > 0 && !form.fee_category_id) { setError("Выберите категорию комиссии"); return; }
    }
    ...
    try {
      const payload = {
        ...
        fee_amount: form.type === "transfer" && form.fee_enabled && Number(form.fee_amount) > 0 ? parseFloat(form.fee_amount) : undefined,
        fee_category_id: form.type === "transfer" && form.fee_enabled && form.fee_category_id ? parseInt(form.fee_category_id) : undefined,
        ...
        <>
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              {form.type === "transfer" && <TransferFeeFields form={form} setForm={setForm} categories={categories} />}
