...
const emptyForm = defaultKind => ({ name: "", kind: defaultKind, direction: defaultKind === "deposit" ? "receivable" : "owe", currency: "RUB", counterparty: "", original_amount: "", current_balance: "", credit_limit: "", monthly_payment: "", annual_interest_rate: "", early_repayment_mode: "reduce_term", interest_payout_frequency: "monthly", capitalization: false, interest_accrual_mode: "manual", opened_at: "", due_day: "", statement_day: "", next_payment_date: "", end_date: "", reminder_days_before: "3", source_account_id: "", linked_account_id: "", funds_received: false, funds_account_id: "", category_id: "", notes: "" });
...
function PaymentModal({ item, payment, setPayment, accounts, busy, onSubmit, onCancel }) {
  const isDeposit = item.kind === "deposit";
