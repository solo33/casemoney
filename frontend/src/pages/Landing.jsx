...
export default function Landing() {
  ...
  <section className="landing-plans"><div><p className="landing-kicker">Два режима работы</p><h2>Выберите удобный формат и измените его в любой момент</h2><p>Personal подходит для простого личного учёта. Family добавляет совместные расходы, планирование, расширенные цели, обязательства, депозиты и семейные сценарии. На этапе бесплатного запуска доступны оба режима.</p></div><div className="landing-plan-cards"><article><strong>Personal</strong><span>Простой личный учёт</span><p>Счета, операции, импорт, категории, базовые отчёты, список покупок и PWA.</p></article><article><strong>Family</strong><span>Семейные финансы</span><p>Участники, взаиморасчёты, планирование, цели, обязательства, депозиты и расширенная аналитика.</p></article></div></section>
      <section className="landing-family">
        <div className="landing-family-intro"><p className="landing-kicker">Family</p><h2>Общие деньги — без потери личной картины</h2><p>Отмечайте совместные покупки прямо при вводе операции. CaseMoney покажет, кто оплатил, сколько вложил каждый и кому нужно компенсировать расходы.</p><Link to="/register">Попробовать Family</Link></div>
        <div className="landing-family-flow" aria-label="Возможности тарифа Family">
          <article><span>01</span><h3>Общая покупка</h3><p>Расход остаётся на личном счёте, но появляется в семейной картине.</p></article>
          <article><span>02</span><h3>Планы и цели</h3><p>Бюджеты, будущие платежи, накопления, кредиты и депозиты — в одном плане.</p></article>
          <article><span>03</span><h3>Итоги месяца</h3><p>Понимайте динамику общих трат, вклад участников и ближайшие риски.</p></article>
        </div>
      </section>
