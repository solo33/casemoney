...
const pages = [
  ...
  },
  {
    ...
    body: `<main><h1>Помощь по CaseMoney</h1><h2>Основные разделы</h2><p>Начало работы, счета и остатки, операции, валюты, категории, импорт и экспорт, отчёты, цели, семейные финансы, обязательства, депозиты, уведомления и установка приложения.</p><p><a href="mailto:support@casemoney.ru">Связаться с поддержкой</a></p></main>`,
  },
